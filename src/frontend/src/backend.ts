...
import type { CVData as _CVData, ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async clearCV(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearCV();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllCVs(): Promise<Array<CVData>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCVs();
    ...
    async saveCV(arg0: CVData): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveCV(await to_candid_CVData_n19(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadPhoto(arg0: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadPhoto(await to_candid_ExternalBlob_n21(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_CVData_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CVData): Promise<CVData> {
...
async function from_candid_opt_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_CVData]): Promise<CVData | null> {
    return value.length === 0 ? null : await from_candid_CVData_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CVData>): Promise<Array<CVData>> {
    return await Promise.all(value.map(async (x)=>await from_candid_CVData_n11(_uploadFile, _downloadFile, x)));
}
async function to_candid_CVData_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: CVData): Promise<_CVData> {
...
async function to_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        email: value.email,
        phone: value.phone,
        photo: value.photo ? candid_some(await to_candid_ExternalBlob_n21(_uploadFile, _downloadFile, value.photo)) : candid_none(),
        skills: value.skills
    };
}
